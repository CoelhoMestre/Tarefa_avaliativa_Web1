                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="editar-produto.php?id=<?= $produto->getIdProduto() ?>" class="btn btn-primary">editar</a>
                                <button onclick="deletarProdutos('<?= $produto->getIdProduto() ?>', '<?= $produtos->getNome() ?>')" class="btn btn-primary">apagar</button>
                            </div>
                        </td> 
                    </tr> <?php
                }
