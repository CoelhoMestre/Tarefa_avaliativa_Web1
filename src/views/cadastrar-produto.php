    ...
    <div class="container">
        ...
        <form class='form' action="./cadastrar-produto.php" method="POST">
            ...
            <div class="input">
                    ...
                    <input type="text" step="any" name="marca" class="form-control" id="marca" required>
                </div>
        ...
        <?php
            ...
            try {
                $produto->insert($produto->getNome(),$produto->getMarca(), $produto->getPreco(), $produto->getQuantidade());
