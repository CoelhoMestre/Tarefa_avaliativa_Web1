...
<body class="text-center">
    ...
    <div class="container">
        ...
        <div class="menu p-2">
            ...
            <a href="./realizar-venda.php" class="btn btn-primary">Realizar venda</a>
        </div>
        <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="./editar-venda.php?id=<?= $venda->getIdVenda() ?>" class="btn btn-primary">editar</a>
                                    <a href="#" class="btn btn-primary">ver+</a>
                                    <button onclick="deletarVendas('<?= $venda->getIdVenda() ?>')" class="btn btn-primary">apagar</button>
                                </div>
                            </td>
                        </tr> <?php
                    }
